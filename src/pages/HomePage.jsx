            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black">
                ...
                <div className="relative container mx-auto px-4 py-20 lg:py-32">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h2 className="mt-6 text-2xl lg:text-4xl lg:leading-[3rem] font-bold mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                            चलो{" "}
                        ...
                        <div className="mt-12 text-center">
                            <Badge
                                variant="secondary"
                                className="bg-orange-500/20 text-orange-400 px-4 py-2 text-sm"
                            >
