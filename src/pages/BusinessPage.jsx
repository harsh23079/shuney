...
export default function BusinessPage() {
    ...
    const fetchCategories = useCallback(async () => {
        ...
        try {
            ...
            // ✅ Fixed comparison logic - only compare if we have existing data
                    ...
                    <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-6 mb-6">
                        ...
                        <div className="text-gray-400 text-sm">
                            ...
                            <ul className="mt-2 space-y-1">
                                ...
                                <li>
                                    • Check if the "categories" collection
                                    exists
                                </li>
                            </ul>
                        </div>
        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="container mx-auto px-4 py-12">
                    ...
                    <div className="text-center py-12">
                        <div className="bg-gray-900/50 border border-gray-700 rounded-lg p-8">
                            ...
                            <p className="text-gray-500 text-sm mb-6">
                                Make sure you have categories in your Firestore
                                database.
                            </p>
                            <Button
                                onClick={handleRefresh}
                ...
                {isLoading && businesses.length > 0 && (
                    <div className="fixed bottom-4 right-4 bg-gray-900 border border-gray-700 rounded-lg p-3 shadow-lg z-50">
                ...
                {/* ✅ Fixed "No new results" message */}
                {noNewResults && (
                    <div className="fixed top-28 left-1/2 transform -translate-x-1/2 bg-orange-600 border border-white-500 text-white px-6 py-3 rounded-lg shadow-lg z-50 ">
                        <div className="flex items-center gap-2">
                            <RefreshCw className="w-4 h-4" />
                            <p className="text-sm font-medium">
                                No new results found - data is up to date!
                            </p>
                        </div>
                    </div>
                )}
