...
export default function LevelVideosPage() {
    ...
    const fetchVideos = useCallback(async (pageNo = "1") => {
        ...
        try {
            console.log("Fetching videos for levelId:", levelId, "pageNo:", pageNo);
            ...
            <div className="min-h-screen bg-black text-white flex items-center justify-center">
                <div className="text-center max-w-md">
                    ...
                    <div className="space-y-3">
                        ...
                        <Link to={`/levels/${levelId.split('-').slice(0, -1).join('-')}`}>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">
                                Page {currentPage} of {Math.max(...Array.from(availablePages).map(p => parseInt(p)))}
                            </p>
                        </div>
                        ...
                        {availablePages.size > 1 && (
                            <div className="flex items-center gap-2 ml-auto">
                                {Array.from(availablePages).sort().map(page => (
                                    <Button
                                        key={page}
                                        variant="outline"
                                        size="sm"
                                        ...
                                        <CardContent className="p-3">
                                            <div className="flex gap-3">
                                                <div className="relative flex-shrink-0">
                                                    <img
                                                        src={getImageUrl(video.thumbnailId)}
                                                        alt={video.levelVideoName}
                                                        className="w-24 h-16 object-cover rounded"
                                                        onError={(e) => handleImageError(video.thumbnailId, e)}
                                                    />
